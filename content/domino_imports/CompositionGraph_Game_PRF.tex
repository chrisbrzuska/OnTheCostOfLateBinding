\begin{tikzpicture}
\node[anchor=south west,align=center,package,minimum height=2cm,fill=white] (node0) at (7,3) {$\M{input\_key}^{10}$};\node[anchor=south west,align=center,package,minimum height=2.5cm,fill=white] (node1) at (3.5,1.5) {\M{prf}};\node[anchor=south west,align=center,package,minimum height=2cm,fill=white] (node2) at (7,0.5) {$\M{output\_key}^{bb}$};\draw[-latex,rounded corners]
